...
INT WINAPI wWinMain( HINSTANCE, HINSTANCE, LPWSTR, int )
{
	...
	/*
	수직동기화 푸는 법 Game.cpp에서 DXUTInit를 검색해서 이동 후, 그 위에 다음 내용 추가
	auto setting = DXUTGetDeiceSettings();
	setting.d3d9.pp.PresentationInterval = D3DPRESENT_INTERVAL_IMMEDIATE;
	setting.d3d9.pp.Windowed = true;

	DXUTCreateDevice( STATE_IS_WINDOW, WINDOW_WIDTH, WINDOW_HEIGHT );	//이 부분 지우고
